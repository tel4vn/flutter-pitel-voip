class PitelConfigure {
  ...
  //! PROD
  // static String get apiPushUrl => 'https://api-pusher.tel4vn.com/v1'; // PROD
  static String get apiPushUrl =>
      'https://api.pitel-pusher.tel4vn.com/v1'; // RC
  // static String get apiPushUrl =>
  //     'https://api.pitel-pusher.dev.tel4vn.com/v1'; // DEV
